...
function sahar_scripts() {
	...
	wp_enqueue_style( 'sahar-frontend', get_template_directory_uri() . '/dist/frontend-style.css', array( 'sahar-style' ), SAHAR_VERSION );

	wp_enqueue_script( 'sahar-frontend', get_template_directory_uri() . '/dist/frontend-bundle.js', array( 'jquery' ), SAHAR_VERSION, true );
